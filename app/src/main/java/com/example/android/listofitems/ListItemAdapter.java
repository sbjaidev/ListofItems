...
class ListItemAdapter extends ArrayAdapter<ListMember> {
     ...
     */
    ListItemAdapter(Context context, ArrayList<ListMember> listItemsArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView title = (TextView) listItemView.findViewById(R.id.list_item_title);
        title.setText(currentItem.getTitle());

        TextView description = (TextView) listItemView.findViewById(R.id.list_item_description);
